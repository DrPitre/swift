...
// RUN: %target-swift-frontend(mock-sdk: -enable-source-import -sdk %t/sdk -I %t/sdk/swift-modules) -target %target-swift-5.9-abi-triple -swift-version 6 -I %S/Inputs/dependencies -parse-as-library -dump-ast -dump-ast-format json %s -module-name main -o - >/dev/null
